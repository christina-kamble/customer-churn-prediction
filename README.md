...
- **Cost-sensitive threshold optimisation** - tune the classification threshold around a real business cost matrix
  (false negative = lost customer ~£300; false positive = wasted retention offer ~£20) rather than defaulting to 0.5
